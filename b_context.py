...
MASTER_TEMPLATE: dict = {
    ...
    # служебные флаги. не трогать
    # runtime-флаги динамического состояния
    "cmd_state": {
...
# можно задать дефолтные настройки:
COPY_TEMPLATE: dict = {
...
class MainContext:
    ...
    def __init__(self):
        ...
        if ADMIN_CHAT_ID:
            self.admin_chat_id: int = int(ADMIN_CHAT_ID)
        ...
        self.master_payload: MasterPayload | None = None
