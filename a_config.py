...
# ============================================================
LOG_DEBUG:     bool = False   # необязатльеный уровень логирования
LOG_INFO:      bool = True    # необязатльеный уровень логирования
LOG_WARNING:   bool = True    # обязатльеный уровень логирования
LOG_ERROR:     bool = True    # обязатльеный уровень логирования
MAX_LOG_LINES: int = 1000     # приблизительный размер длины лог файлов
